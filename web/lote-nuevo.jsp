            ...
            <section class="full-box page-content">
                ...
                <div class="page-header">
                    <h3 style="color:#ffffff ">
                        <i class="fas icon-v-card"></i> 
                        AGRICULTOR:
                        <span class="text-info"><%=Variables.agriNombre%>  &nbsp; <%=Variables.agriApellido%> &nbsp;</span>
                    </h3>
                    <h3  style="border: 1px solid; width: 12%">
                        <i class="fas icon-news text-danger"></i> Nuevo Lote <br>
                    </h3>
                </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox"    value="SI" name="checBodega" onclick="mostrar1()">
                                        <input type="text" class="texto"  name="txtObBodega" style="display: none" id="chec1"  placeholder="Observación de la bodega"  >
                                    </div>
                                    <div class="col-md-6">
                                        <label class="etiqueta">Poscosecha</label>
                                        <input type="checkbox"   value="SI"  name="checPoscosecha" onclick="mostrar2()"  >
                                        <input type="text" class="texto"      name="txtOb_poscosecha"  placeholder="Observación de la poscosecha"  id="chec2"  style="display: none">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="" class="etiqueta">Capacitacion</label>
                                        <input type="checkbox" value="SI"  name="checCapacitacion" onclick="mostrar3()"  >
                                        <input type="text" class="texto"   name="txtObCapacitacion" placeholder="Observación de la Capacitación" id="chec3"  style="display: none">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="" class="etiqueta"> Medio de Trasporte</label>
                                        <input type="checkbox"  value="SI"  name="checTransp" onclick="mostrar4()"  >
                                        <input type="text" class="texto"   name="txtObTransporte" placeholder="Observación en el medio de trasporte" id="chec4"  style="display: none">
                                    </div>
