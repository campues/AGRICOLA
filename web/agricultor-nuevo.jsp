                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control"  name="txtNom1" value="${agricul.nombre1}" required="" pattern="[A-Za-z]+">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txtApe1" value="${agricul.apellido1}"required="" pattern="[A-Za-z]+">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <div class="form-group">
